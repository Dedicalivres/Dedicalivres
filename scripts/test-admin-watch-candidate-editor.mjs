...
assert.ok(
  source.includes('isActiveWorkflow ? renderWatchSubmissionPreview(result, index) : ""') &&
    source.includes('const isClosedWorkflow = ["handled", "duplicate", "submitted", "rejected"].includes(workflowState)'),
