...
assert.match(v11, /Le retrait réversible reste verrouillé tant que son backend n’est pas validé/);
assert.match(config, /adminV11CommunityArchiveEnabled: false/);
