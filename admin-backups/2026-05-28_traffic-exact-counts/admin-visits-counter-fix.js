...
(function () {
  ...
  function renderTrafficCounters(rows) {
    ...
    setPlainText("traffic-overview-today", countSince(rows, 1, true));
    setPlainText("traffic-overview-week", countSince(rows, 7, false));
    setPlainText("traffic-overview-month", countSince(rows, 30, false));
    setPlainText("traffic-overview-total", rows.length);
  }
